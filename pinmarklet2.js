            ...
            return {
                ...
                ping: {
                    ...
                    preferred: function(b) {
                        ...
                        if (b.data) {
                            ...
                            a.v.data.preferred = b.data.reply;
                            var c;
                            c = {};
                ...
                lookupThumb: function(b, c) {
                    ...
                    if (a.v.hazCalledForInfo[b])
                        ...
                        c = a.a.embed + "?" + e + "=" + encodeURIComponent(d).replace(/^https/, "http");
                            ...
                            if (!d)
                                ...
                                if (d = a.f.grovel(l, b[e]))
                                    ...
                                    if (typeof a.a.lookup[d][b[e]].patch === "function" && a.a.lookup[d][b[e]].att && a.f.get(k, a.a.lookup[d][b[e]].att))
                                        l = a.a.lookup[d][b[e]].patch(a.f.get(k, a.a.lookup[d][b[e]].att));
                ...
                checkPage: function() {
                    ...
                    if (c) {
                        ...
                        if (b.doNotCrawl)
                            a.v.doNotCrawl = true; ! a.v.data.close && typeof b.patch === "function" && b.patch(a)
                        }
    ...
    lookup: {
        ...
        imdb: {
            img: {
                ...
                patch: function(g) {
                    return g.replace(/@@(.*)/, "@@._V1_SX800.jpg")
                    }
            }
        },
        kickstarter: {
        ...
        youtube: {
            ...
            video: {
                ...
                patch: function(g) {
                    var i = null;
                    if (g)
                        i = "http://www.youtube.com/embed/" + g;
                    return i
                }
            },
            iframe: {
